    ...
    Friend Function ConstituentsToOutput(ByVal aType As String, _
        ...
        Select Case aType
            ...
            Case "TotalN" 'use PQUAL
                ...
                lConstituentsToOutput.Add("P:Header3", "BOD (lb/ac)")
                ...
                lConstituentsToOutput.Add("I:Header5", "NH3+NH4 (lb/ac)")
                lConstituentsToOutput.Add("I:SOQUAL-NH3+NH4", "SOQUAL")
                lConstituentsToOutput.Add("I:Header6", "NO3 (lb/ac)")
                lConstituentsToOutput.Add("I:SOQUAL-NO3", "SOQUAL")

                lConstituentsToOutput.Add("I:Header7", "BOD (lb/ac)")
                ...
                lConstituentsToOutput.Add("R:Header16", "Totals")
