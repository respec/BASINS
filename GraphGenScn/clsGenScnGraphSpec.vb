...
Public Class clsGenScnGraphSpec
    ...
    Private pATCoRendFileName As String = "ATCoRend.dbf"
        ...
        Get
            If pATCoRendDBF Is Nothing Then
                ...
                Else
                    ...
                    pATCoRendFileName = FindFile("", pATCoRendFileName)
                    If IO.File.Exists(pATCoRendFileName) Then
                        Try
                            If pATCoRendDBF.OpenFile(pATCoRendFileName) Then Return pATCoRendDBF
                        Catch Ex As Exception
                            Logger.Msg("Cannot read file from disk: " & Ex.Message)
