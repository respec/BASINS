...
Public Module atcHspfAGCHEM
    ...
    Private Function AllFluxes() As atcCollection
        ...
        With lAll
            ...
            .Add("P:Header1", "Applications (lb/a)")
            .Add("P:AMMONIA APPLICATION", "    NH3-N")
            .Add("P:NITRATE APPLICATION", "    NO3-N")
            .Add("P:ORGANIC N APPLICATION", "    ORGN")
            .Add("P:Header2", "Above Ground Plant Uptake")
            .Add("P:TAMUPA", "    NH3-N")
            .Add("P:TNIUPA", "    NO3-N")
            .Add("P:Header3", "Below Ground Plant Uptake")
            .Add("P:TAMUPB", "    NH3-N")
            .Add("P:TNIUPB", "    NO3-N")
            .Add("P:RETAGN", "Above Gr Plant N to Litter")
            .Add("P:Header4", "Litter N Return to Labile ORGN")
            .Add("P:SRTLLN", "    Surface")
            .Add("P:URTLLN", "    Upper")
            .Add("P:TRTLLN", "    Total")
            .Add("P:Header5", "Litter N Return to Refractory ORGN")
            .Add("P:SRTRLN", "    Surface")
            .Add("P:URTRLN", "    Upper")
            .Add("P:TRTRLN", "    Total")
            .Add("P:Header6", "BG Plant N Return to Labile ORGN")
            .Add("P:SRTLBN", "    Surface")
            .Add("P:URTLBN", "    Upper")
            .Add("P:LRTLBN", "    Lower")
            .Add("P:TRTLBN", "    Total")
            .Add("P:Header7", "BG Plant N Return to Refractory ORGN")
