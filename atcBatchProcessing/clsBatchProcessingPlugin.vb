...
Public Class clsBatchProcessingPlugin
    Inherits atcData.atcDataDisplay

    Private pRequiredHelperPlugin As String = "Analysis::Batch Processing"

    Public Overrides ReadOnly Property Name() As String
        Get
            Return "Analysis::USGS Batch Processing"
        End Get
    End Property
    ...
    Public Overrides Function Show(ByVal aTimeseriesGroup As atcData.atcDataGroup) As Object
        ...
        Show = Nothing
        Dim lBatchTitle As String = "Batch Processing Setup"
        Dim lChoice As String = Logger.MsgCustomOwned("Please choose analysis approach below:", _
                                                      "Batch Analysis", _
                                                      Nothing, _
                                                      New String() {"Interactive", "Batch Spec File", "Batch Map"})
        If lChoice = "Batch Spec File" Then
