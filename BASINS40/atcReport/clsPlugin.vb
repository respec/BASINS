...
Public Class PlugIn
  ...
  Private Const ReportsMenuName As String = "BasinsReports"
  Private Const ReportsMenuString As String = "Reports"
  ...
  Public ReadOnly Property Name() As String Implements MapWindow.Interfaces.IPlugin.Name
    ...
    'this plug-in.
    Get
      Return "BASINS Watershed Characterization Reports"
    End Get
  End Property
  ...
  Public Sub Initialize(ByVal MapWin As MapWindow.Interfaces.IMapWin, ByVal ParentHandle As Integer) Implements MapWindow.Interfaces.IPlugin.Initialize
    ...
    pMapWin.Menus.AddMenu(ReportsMenuName, "", Nothing, ReportsMenuString, "mnuFile")
    mnu = pMapWin.Menus.AddMenu(ReportsMenuName & "_Watershed", ReportsMenuName, Nothing, "Watershed Characterization Reports")
  ...
  Public Sub Terminate() Implements MapWindow.Interfaces.IPlugin.Terminate
    ...
    pMapWin.Menus.Remove(ReportsMenuName)
    pMapWin.Menus.Remove(ReportsMenuName & "_Watershed")
  ...
  Public Sub ItemClicked(ByVal ItemName As String, ByRef Handled As Boolean) Implements MapWindow.Interfaces.IPlugin.ItemClicked
    ...
    If ItemName = ReportsMenuName & "_Watershed" Then
      GisUtil.MappingObject = pMapWin
      Dim main As New frmReport
      main.InitializeUI(pMapWin)
      main.Show()
      Handled = True
    End If
  End Sub
