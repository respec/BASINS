Public Class PlugIn
  ...
  Public ReadOnly Property Description() As String Implements MapWindow.Interfaces.IPlugin.Description
    ...
    'your plug-in.  
    Get
      Return "This plug-in provides an interface for changing the projection of a shapefile or grid."
    End Get
  End Property
  ...
  Public Sub Initialize(ByVal MapWin As MapWindow.Interfaces.IMapWin, ByVal ParentHandle As Integer) Implements MapWindow.Interfaces.IPlugin.Initialize
    ...
    mnu = pMapWin.Menus.AddMenu(UtilitiesMenuName & "_ChangeProjection", UtilitiesMenuName, Nothing, "&Change Projection")
  ...
  Public Sub Terminate() Implements MapWindow.Interfaces.IPlugin.Terminate
    ...
    pMapWin.Menus.Remove(UtilitiesMenuName & "_ChangeProjection")
  ...
  Public Sub ItemClicked(ByVal ItemName As String, ByRef Handled As Boolean) Implements MapWindow.Interfaces.IPlugin.ItemClicked
    ...
    If ItemName = "BasinsUtilities_ChangeProjection" Then
      Dim main As New frmChangeProjection
