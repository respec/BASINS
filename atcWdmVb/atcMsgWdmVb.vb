                ...
                For lInd As Int32 = 1 To lDataPointerCount
                    ...
                    If lV > 0 Then
                        ...
                        Else
                            lAttr.Editable = True
                        End If
                        Dim lPreferredName As String = atcDataAttributes.PreferredName(lAttr.Name)
                        If lPreferredName <> lAttr.Name Then
                            Logger.Dbg("WDM attribute " & lAttr.Name & " renamed " & lPreferredName)
                            lAttr.Name = lPreferredName
                        End If
