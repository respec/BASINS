...
Private Sub Form_Load()
  ...
  End With
  fraButtons.Top = fraSummary.Top + fraSummary.Height + 108
  ...
  frmWDMUSumm.Height = fraButtons.Top + fraButtons.Height + 456
...
Private Sub Form_Resize()
  Dim fraWidth&, innerWidth&
  'Dim fraHeight&, innerHeight&
  
  fraWidth = Me.ScaleWidth - 216
  innerWidth = fraWidth - 240
    
  If innerWidth > 500 Then
    fraSpec.Width = fraWidth
    fraDetails.Width = fraWidth
    fraSummary.Width = fraWidth
    agdSpec.Width = innerWidth
    txtDetails.Width = innerWidth
    agdSumm.Width = innerWidth
