...
"The time period from the EXS file will be used for the hydrologic calibration", vbOKOnly)
    ...
    Public Function AsString() As String
        ...
        lText.AppendLine("***This Basins Specification file (EXS) file has been generated from WinHSPF.")
        lText.AppendLine("<WDMNAME><Ste><cSt><LatMin><LatMax><LngMin><LngMax><yyyymmdd><yyyymmdd>***")
        ...
        lText.AppendLine("SIMQFLOWSUROIFOWAGWOSUPYPETXSAETUZSXLZSX     LOCATION***")
