...
Public Class clsBatchUtil
    ...
    Public Shared Sub DownloadData(ByVal aStationList As atcCollection)
        ...
        Dim lDownloadManager As New D4EMDataManager.DataManager()
        MapWinUtility.Logger.Status("LABEL TITLE Downloading from NWIS")
        Dim lResult As String = lDownloadManager.Execute(XML(aStationList))
