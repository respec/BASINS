...
Public Module modScript
    ...
    Public Function RunScript(ByVal code As String, ByVal args() As Object) As Object
    ...
    Public Function CompileScript(ByVal code As String, ByRef errors As String, ByVal refs() As String) As System.Reflection.Assembly
