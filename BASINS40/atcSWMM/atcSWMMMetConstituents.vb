'Replaced by separate classes atcSWMMEvaporation and atcSWMMTemperature
...
'Public Class atcSWMMMetConstituents
...
'    Public Sub New(ByVal aSWMMPRoject As atcSWMMProject, ByVal aName As String)
'        pSWMMProject = aSWMMPRoject
'        Name = aName
'    End Sub

'    Public Sub New(ByVal aSWMMPRoject As atcSWMMProject, ByVal aName As String, ByVal aContents As String)
'        pSWMMProject = aSWMMPRoject
'        Name = aName
