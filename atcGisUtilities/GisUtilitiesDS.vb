...
Public Class GisUtilities
    ...
    Public Shared Sub GridSourceToShapefile(ByVal aMapWin As Object, _
        ...
        GisUtilDS.MappingObject = aMapWin
        ...
        'GisUtilDS.CreatePointShapefile(aShapefileName, lXPositions, lYPositions, lAttributeNames, lAttributeValues, aOutputProjection)
