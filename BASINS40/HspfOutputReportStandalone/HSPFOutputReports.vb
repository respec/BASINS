...
Module HSPFOutputReports
    ...
    Private pHSPFExe As String = "S:\dev\Packages\BASINS41_Install_2012-10-11\models\HSPF\bin\WinHspfLt.exe"
    ...
    Private Sub Initialize()
        ...
        'Dim lTestname As String = "Darby"
        'Dim lTestname As String = "Prospect"
        ...
        'Dim lTestName As String = "LPCal03"
        'Dim lTestName As String = "CWCal03"
        'Dim lTestName As String = "RECal03"
        ...
        '        pGraphAnnual = True
        '    Case "IRW"
        '        pTestPath = "S:\Documents\My Dropbox\FilesForMarkforOutputReports"
        '        pBaseName = "IRW"
        ...
        '        pOutputLocations.Add("R:308")
        '        pOutputLocations.Add("R:600")
        '        pOutputLocations.Add("R:602")
        '        pOutputLocations.Add("R:120")
        '        pOutputLocations.Add("R:706")
        '        pOutputLocations.Add("R:660")
        '        pOutputLocations.Add("R:800")
        '        pOutputLocations.Add("R:850")
        '        pOutputLocations.Add("R:726")
        '        pOutputLocations.Add("R:906")
        '        pOutputLocations.Add("R:916")
        '        pOutputLocations.Add("R:936")
        '        pCurveStepType = "NonStep" 'Tony's convention
        '        'pGraphAnnual = True
        '        'pRunHSPF = True
        '    Case "tutorial"
    ...
    Public Sub Main()
        ...
        pTestPath = Command()
        If Not IO.File.Exists(pTestPath) Then
            Dim lCdlg As New Windows.Forms.OpenFileDialog
            With lCdlg
                .Title = "Select UCI File"
                .Filter = "UCI Files (*.uci)|*.uci"
                .FilterIndex = 0
                If .ShowDialog() = Windows.Forms.DialogResult.OK Then
                    pTestPath = AbsolutePath(.FileName, CurDir)
                End If
            End With
        End If
        If Not IO.File.Exists(pTestPath) Then
            MsgBox(pTestPath, MsgBoxStyle.Critical, "UCI File Not Found")
            End
        End If
        pBaseName = IO.Path.GetFileNameWithoutExtension(pTestPath)
        pTestPath = IO.Path.GetDirectoryName(pTestPath)
        ...
        Dim lDateString As String = Format(Year(lRunMade), "00") & "_" & Format(Month(lRunMade), "00") & _
                "_" & Format(Microsoft.VisualBasic.Day(lRunMade), "00") & "_" & Format(Hour(lRunMade), "00") & "_" & Format(Minute(lRunMade), "00")
    ...
    Private Sub GraphWQDuration()
        ...
        Dim lp As String = ""
        Dim lf As String = "S:\Documents\My Dropbox\FilesForMarkforOutputReports\graphWQlog.txt"
