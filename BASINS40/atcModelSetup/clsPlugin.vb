...
Public Class PlugIn
  ...
  Public ReadOnly Property Name() As String Implements MapWindow.Interfaces.IPlugin.Name
    ...
    'this plug-in.
    Get
      Return "ModelSetup (HSPF/AQUATOX)"
    End Get
  End Property
  ...
  Public ReadOnly Property Description() As String Implements MapWindow.Interfaces.IPlugin.Description
    ...
    'your plug-in.  
    Get
      Return "This plug-in provides an interface for initializing two commonly-used basins models, HSPF and AQUATOX."
    End Get
  End Property
  ...
  Public Sub Initialize(ByVal MapWin As MapWindow.Interfaces.IMapWin, ByVal ParentHandle As Integer) Implements MapWindow.Interfaces.IPlugin.Initialize
    ...
    If pMapWin.Plugins.PluginIsLoaded("BASINS4_PlugIn") Then
  ...
  Public Sub Terminate() Implements MapWindow.Interfaces.IPlugin.Terminate
    ...
    If Not pMapWin.Plugins.PluginIsLoaded("BASINS4_PlugIn") Then
