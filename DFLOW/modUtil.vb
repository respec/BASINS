...
Public Module modUtil
    ...
    Public Class InputNames
        ...
        Public Shared BioPeriod As String = "(Bio) Flow Averaging Period (days)"
        Public Shared BioPeriodText As String = "(Bio) Flow Averaging Period (days)"
        Public Shared BioYearsText As String = "(Bio) Return Period of Excursions (years)"
        Public Shared BioClusterDays As String = "BioClusterDays"
