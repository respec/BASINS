...
Public Class atcTimeseriesGridSource
    ...
    Sub New(ByVal aDataGroup As atcDataDotSpatial.atcTimeseriesGroup,
            ...
            Select Case aColumn
                ...
                Case Is < Columns
                    ...
                    If aRow < lAttributeRows Then
                        ...
                        Dim lDefinition As atcAttributeDefinition = atcDataDotSpatial.atcDataAttributes.GetDefinition(lAttributeName)
