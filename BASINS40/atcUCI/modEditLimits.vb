...
Module modEditLimits
	...
	Public Sub GetNonExistentDataSetInfo(ByRef i As Integer, ByRef adsn As Integer, ByRef wid As String, ByRef s As String, ByRef l As String, ByRef c As String)
	...
	Public Sub UpdateRespFromAddDataSet(ByRef i As Short)
