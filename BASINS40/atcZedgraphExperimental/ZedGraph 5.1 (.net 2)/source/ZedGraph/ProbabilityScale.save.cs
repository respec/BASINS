...
namespace ZedGraph
{
    ...
    class ProbabilityScale : Scale, ISerializable //, ICloneable
    {
        ...
        /// </summary>
        double deviationScale = 1 / 6; // = 1 / (2 * standardDeviations);
        ...
        override public double Linearize(double val)
        {
            ...
            return val;// deviationScale * (gausex(val) + standardDeviations);
        }
        ...
        {
            return val; //TODO: reverse Linearize
        }
        ...
        //{
        //    int ticInt = (int)tic;
        //    if (ticInt >= 0 && ticInt <= percentages.GetUpperBound(0))
        //        return percentages[ticInt] / 100;
        //    else
        //        return 0;
        //}
        ...
        //{
        //    return percentages.GetUpperBound(0);
        //}
        ...
        public double gausex(double exprob)
        {
            ...
            try
            {
                p = exprob;
                if (p >= 1)
                    rtmp = -10; //set to minimum
                else if (p <= 0)
                    rtmp = 10;  //set at maximum
                else            //compute value
                {
                    pr = p;
                    if (p > 0.5) pr = 1 - pr;
