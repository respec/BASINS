    ...
    Else
      ...
      Try
        ...
        ElseIf lDateCol < 0 Then
          Open = False
          Logger.Msg("Unable to identify Date column in BASINS Observed Water Quality file " & aFileName, "SWAT DBF Open")
        ElseIf lTimeCol < 0 Then
          Open = False
          Logger.Msg("Unable to identify Time column in BASINS Observed Water Quality file " & aFileName, "SWAT DBF Open")
        ElseIf lLocnCol < 0 Then
          Open = False
          Logger.Msg("Unable to identify ID column in BASINS Observed Water Quality file " & aFileName, "SWAT DBF Open")
        ElseIf lConsCol < 0 Then
          Open = False
          Logger.Msg("Unable to identify Parm column in BASINS Observed Water Quality file " & aFileName, "SWAT DBF Open")
        ElseIf lValCol < 0 Then
          Open = False
          Logger.Msg("Unable to identify Value column in BASINS Observed Water Quality file " & aFileName, "SWAT DBF Open")
        End If
