...
Public Class atcDataSource
    ...
    Public Overridable Function AddDataSets(ByVal aDataGroup As atcDataGroup) As Boolean
        ...
        For Each lDataSet As atcDataSet In aDataGroup
            If AddDataSet(lDataSet, atcDataDotSpatial.atcDataSource.EnumExistAction.ExistRenumber) Then
                lNumSaved += 1
            End If
        Next
    ...
    Public Overridable Function RemoveDataset(ByVal aDataSet As atcDataDotSpatial.atcDataSet) As Boolean
