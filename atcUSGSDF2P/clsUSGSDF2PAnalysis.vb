...
Public Class clsUSGSDF2PAnalysis
...
#End If
    ...
    Public Overrides Function Show(ByVal aTimeseriesGroup As atcData.atcDataGroup) As Object
        ...
        ElseIf lTimeseriesGroup.Count > 1 Then
            Logger.Msg("DF2P analyzes one daily streamflow dataset at a time.", "Two-Param Digital Filter")
        Else
            Logger.Msg("Need to select a daily streamflow dataset", "Two-Param Digital Filter")
        End If
    End Function
