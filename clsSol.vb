    ...
    Public Class clsSolItem
        ...
        Public Shared ReadOnly Property Units() As Dictionary(Of String, String)
            ...
            Get
                ...
                unitsDictionary.Add("SOL_ZMX", "mm")
                unitsDictionary.Add("ANION_EXCL", "fraction")
                unitsDictionary.Add("SOL_CRK", "fraction")
                unitsDictionary.Add("TEXTURE", "")
                unitsDictionary.Add("SOL_Z", "mm")
                'unitsDictionary.Add("SOL_BD", "g/cc")
                unitsDictionary.Add("SOL_BD", "g/cm3")
                unitsDictionary.Add("SOL_AWC", "fraction")
                ...
                unitsDictionary.Add("SOL_ALB", "none")
                unitsDictionary.Add("USLE_K", "number")
                unitsDictionary.Add("SOL_EC", "none")
