Partial Class SwatInput
    ...
    Public Class clsChm
        ...
        Public Sub AddChm(ByVal SUBBASIN As Double, _
                          ByVal HRU As Double, _
                          ByVal LANDUSE As String, _
                          ByVal SOIL As String, _
                          ByVal SLOPE_CD As String, _
                          ByVal SOL_NO3() As Double, _
                          ByVal SOL_ORGN() As Double, _
                          ByVal SOL_LABP() As Double, _
                          ByVal SOL_ORGP() As Double, _
                          ByVal PESTNAME() As String, _
                          ByVal PLTPST() As Double, _
                          ByVal SOLPST() As Double, _
                          ByVal PSTENR() As Double)
            AddChm(SUBBASIN, HRU, LANDUSE, SOIL, SLOPE_CD, _
