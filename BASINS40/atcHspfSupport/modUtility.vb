    ...
    Friend Function ConstituentsToOutput(ByVal aType As String, _
        ...
        Select Case aType
            ...
            Case "TotalN"
                ...
                lConstituentsToOutput.Add("R:TOTORG-IN", "  N-TOTORG-IN")
                lConstituentsToOutput.Add("R:TOTORG-OUT", "  N-TOTORG-OUT")

                lConstituentsToOutput.Add("R:Header14", "REFORG-N")
                lConstituentsToOutput.Add("R:REFORG-IN", "  N-REFORG-IN")
                lConstituentsToOutput.Add("R:REFORG-TOTPROCFLUX-TOT", "  N-REFORG-TOTPROCFLUX-TOT")
                lConstituentsToOutput.Add("R:REFORG-OUT", "  N-REFORG-OUT")
