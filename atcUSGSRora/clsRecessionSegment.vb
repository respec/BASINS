...
Public Class clsRecessionSegment
    ...
    Public TA As Double 'antecedent time
    Public QA As Double 'antecedent flow 
    Public PeakDayIndex As Integer 'TP
    Private pPeakDayDate As Double
    Public Property PeakDayDate() As Double
        Get
            Return pPeakDayDate
        End Get
        Set(ByVal value As Double)
            ...
            Try
                ...
                J2Date(pPeakDayDate, lDate)
                pPeakDayYear = lDate(0)
                pPeakDayMonth = lDate(1)
            Catch ex As Exception

            End Try
        End Set
    End Property
    Private pPeakDayYear As Integer
    Public ReadOnly Property PeakDayYear() As Integer
        Get
            Return pPeakDayYear
        End Get
    End Property
    Private pPeakDayMonth As Integer
    Public ReadOnly Property PeakDayMonth() As Integer
        Get
            Return pPeakDayMonth
        End Get
    End Property

    Public PeakDayFlow As Double 'QP
    Public IndexAfterTimeCritical As Double 'TBC
    Public TS As Integer
    Public TE As Integer
    Public QB As Double
    Public C As Double
    Public QC As Double
    Public DeltaQ As Double
