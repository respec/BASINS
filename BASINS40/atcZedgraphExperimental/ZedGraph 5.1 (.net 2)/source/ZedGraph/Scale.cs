...
*/
		...
		virtual internal SizeF GetScaleMaxSpace( Graphics g, GraphPane pane, float scaleFactor,
							bool applyAngle )
		{
			if ( _isVisible )
			{
...
//				float lastPixVal = -10000;
		...
		/// </param>
		virtual internal void Draw( Graphics g, GraphPane pane, float scaleFactor, float shiftPos )
		{
