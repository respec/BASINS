...
Public Module ReadISHUpdates
    Private Const pInputPath As String = "C:\BASINSMet\backup\WDMRaw-ISHUpdate-2\hi\"
    ...
    Public Sub ScriptMain(ByRef aMapWin As IMapWin)
        ...
        For Each lFile As String In lFiles
            ...
            Dim lAppWDMFile As New atcWDM.atcDataSourceWDM
            lAppWDMFile.Open(lFile)
            ...
            Else
                ...
                lLng = -999
            End If
            Logger.Dbg("ReadISHUpdates: Found " & lAppWDMFile.DataSets.Count & " data sets")
            If lAppWDMFile.DataSets.Count > 0 Then
                lCurState = lFile.Substring(lFile.Length - 13, 2)
                ...
                If lOutFile.Count = 1 Then 'WDM file exists, copy to working version
                    ...
                    lWriteProblem = False
                    Dim lDataSets As atcDataGroup
                    lDataSets = lAppWDMFile.DataSets
                    For Each lDS As atcTimeseries In lDataSets
                        lUpdating = False
                        Dim lWDMDS As atcTimeseries = Nothing
                ...
                ElseIf lOutFile.Count = 0 Then 'new station
                    ...
                    FileCopy(lFile, pOutputPath & lCurState & "\" & lstaid & ".wdm")
                End If
            End If
            lAppWDMFile.DataSets.Clear()
            lAppWDMFile = Nothing
        Next
