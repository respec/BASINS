...
Public Module WeppWrapper
    ...
    Public Sub ScriptMain(ByRef aMapWin As IMapWin)
        Try
            ...
            'Dim lRunId As String = "14"
            'Dim lDsnPREC As Integer = 109

            'Dim lRunId As String = "1"
            'Dim lDsnPREC As Integer = 106

            'Dim lRunId As String = "2"
            'Dim lDsnPREC As Integer = 106

            'Dim lRunId As String = "4"
            'Dim lDsnPREC As Integer = 107

            'Dim lRunId As String = "5"
            'Dim lDsnPREC As Integer = 108

            'Dim lRunId As String = "6"
            'Dim lDsnPREC As Integer = 104

            'Dim lRunId As String = "7"
            'Dim lDsnPREC As Integer = 105

            'Dim lRunId As String = "8"
            'Dim lDsnPREC As Integer = 101

            'Dim lRunId As String = "9"
            'Dim lDsnPREC As Integer = 110

            'Dim lRunId As String = "10"
            'Dim lDsnPREC As Integer = 103

            'Dim lRunId As String = "11"
            'Dim lDsnPREC As Integer = 102

            'Dim lRunId As String = "12"
            'Dim lDsnPREC As Integer = 110

            'Dim lRunId As String = "13"
            'Dim lDsnPREC As Integer = 101

            Dim lRunId As String = "15"
            Dim lDsnPREC As Integer = 108
            ...
            If lWDMDataSource.Open(lWDMFilePath) Then    'use the WDM file name
                ...
                lWritePreamble(5) = "0".ToString.PadLeft(10, lTableDelimiter) & " " & "0".ToString.PadLeft(10, lTableDelimiter) & " " & lElevation.PadLeft(10, lTableDelimiter) & " " & lStrModelEnd(0) - lStrModelBegin(0).ToString.PadLeft(lTableCellWidth, lTableDelimiter) & " " & 1 & " " & lStrModelEnd(0) - lStrModelBegin(0).ToString.PadLeft(lTableCellWidth, lTableDelimiter)
    ...
    Private Function MeanCollectionOfDoubles(ByRef aCollection As Collection) As Double
        ...
        If aCollection.Count > 0 Then
            For i As Integer = 1 To aCollection.Count
