...
Public Class frmWASPFieldMapping
    ...
    Public Sub Init(ByVal aStreamsLayerIndex As Integer, ByVal aSegmentFieldMap As atcCollection, ByVal afrmWASPSetup As frmWASPSetup)
